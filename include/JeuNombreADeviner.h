...
// Paramètres d'entrée: un nombre à deviner
...
// Paramètres d'entrée: nombre d'essais / gagner
// Paramètres d'entrée/sortie : le joueur
...
// Paramètres de sortie: nombre de succés / nombre d'échecs / nombre d'essais
